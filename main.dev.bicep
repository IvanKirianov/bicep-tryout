...
param targetResourceGroup string = 'rg-application-dev-ne'
...
param vNetResourceGroupName string = 'rg-application-dev-ne'
...
param dnsZoneName string = 'dev.application.com'
